...
export class ArticleResolverBase {
  ...
  async getUser(@graphql.Parent() parent: Article): Promise<User | null> {
  ...
  async FetchAllPublishedArticles(
    ...
    return this.service.FetchAllPublishedArticles(args);
  }

  @graphql.Query(() => Article)
  async FetchArticleById(
    @graphql.Args()
    args: ArticleWhereUniqueInput
  ): Promise<Article> {
    return this.service.FetchArticleById(args);
  }
}
