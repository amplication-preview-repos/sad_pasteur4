...
export class ArticleControllerBase {
  ...
  async FetchAllPublishedArticles(
    @common.Body()
    body: ArticleWhereUniqueInput
  ): Promise<Article[]> {
    return this.service.FetchAllPublishedArticles(body);
  }

  @common.Get("/api/articles/:id")
  @swagger.ApiOkResponse({
    type: Article,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async FetchArticleById(
    ...
    return this.service.FetchArticleById(body);
  }
}
